...
add_action( 'init', function() {
	remove_action( 'admin_init', 'rw_register_meta_boxes' );
	add_action( 'admin_init', 'custom_rw_register_meta_boxes' );
});


function custom_rw_register_meta_boxes()
{
