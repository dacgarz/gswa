...
jQuery( document ).ready( function( $ ) {
	...
	$( '#envira-gallery-settings input:not([type=hidden]), #envira-gallery-settings select, #envira-albums-settings input:not([type=hidden]), #envira-albums-settings select' ).conditions( 
		[
			...
			// 	actions: {
			// 		if: {
			// 			element: '#envira-config-social-networks-twitter-box, #envira-config-social-networks-twitter-summary-card',
			// 			action: 'show'
			// 		},
			// 		else: {
			// 			element: '#envira-config-social-networks-twitter-box, #envira-config-social-networks-twitter-summary-card',
			...
			// 		},
			// 		{
			// 			element: '[name="_envira_gallery[social_pinterest]"]',
			// 			type: 'checked',
			// 			operator: 'is'
			// 		}
			// 	],
			// 	actions: {
			// 		if: {
			// 			element: '#envira-config-social-networks-pinterest-type, #envira-config-social-networks-pinterest-rich-row',
			// 			action: 'show'
			// 		},
			// 		else: {
			// 			element: '#envira-config-social-networks-pinterest-type, #envira-config-social-networks-pinterest-rich-row',
			...
			// 		},
			// 		{
			// 			element: '[name="_envira_gallery[social_google]"]',
			// 			type: 'checked',
			// 			operator: 'is'
			// 		}
			// 	],
			// 	actions: {
			// 		if: {
			// 			element: '#envira-config-social-networks-google-default-desc',
			// 			action: 'show'
			// 		},
			// 		else: {
			// 			element: '#envira-config-social-networks-google-default-desc',
			...
			// 	actions: {
			// 		if: {
			// 			element: '#envira-config-social-networks-facebook-what-to-show',
			// 			action: 'show'
			// 		},
			// 		else: {
			// 			element: '#envira-config-social-networks-facebook-what-to-show',
			...
			// 	actions: {
			// 		if: {
			// 			element: '#envira-config-social-lightbox-networks-twitter-box, #envira-config-social-lightbox-networks-twitter-summary-card',
			// 			action: 'show'
			// 		},
			// 		else: {
			// 			element: '#envira-config-social-lightbox-networks-twitter-box, #envira-config-social-lightbox-networks-twitter-summary-card',
			...
			// 		},
			// 		{
			// 			element: '[name="_envira_gallery[social_lightbox_twitter_sharing_method]"]',
			// 			type: 'value',
			// 			operator: 'array',
			// 			condition: [ 'card', 'card-photo' ]
			// 		}
			...
			// 	actions: {
			// 		if: {
			// 			element: '#envira-config-social-lightbox-networks-twitter-summary-card-site, #envira-config-social-lightbox-networks-twitter-summary-card-desc',
			// 			action: 'show'
			// 		},
			// 		else: {
			// 			element: '#envira-config-social-lightbox-networks-twitter-summary-card-site, #envira-config-social-lightbox-networks-twitter-summary-card-desc',
			...
			// 		},
			// 		{
			// 			element: '[name="_envira_gallery[social_lightbox_pinterest]"]',
			// 			type: 'checked',
			// 			operator: 'is'
			// 		}
			// 	],
			// 	actions: {
			// 		if: {
			// 			element: '#envira-config-social-lightbox-networks-pinterest-type, #envira-config-social-lightbox-networks-pinterest-rich-row',
			// 			action: 'show'
			// 		},
			// 		else: {
			// 			element: '#envira-config-social-lightbox-networks-pinterest-type, #envira-config-social-lightbox-networks-pinterest-rich-row',
			...
			// 		},
			// 		{
			// 			element: '[name="_envira_gallery[social_lightbox_google]"]',
			// 			type: 'checked',
			// 			operator: 'is'
			// 		}
			// 	],
			// 	actions: {
			// 		if: {
			// 			element: '#envira-config-social-lightbox-networks-google-default-desc',
			// 			action: 'show'
			// 		},
			// 		else: {
			// 			element: '#envira-config-social-lightbox-networks-google-default-desc',
			...
			// 	actions: {
			// 		if: {
			// 			element: '#envira-config-social-lightbox-networks-facebook-what-to-show',
			// 			action: 'show'
			// 		},
			// 		else: {
			// 			element: '#envira-config-social-lightbox-networks-facebook-what-to-show',
			...
			// 		},
			// 		{
			// 			element: '[name="_envira_gallery[social_lightbox_facebook_show_option_optional_text]"]',
			// 			type: 'checked',
			// 			operator: 'is'
			// 		}
			// 	],
			...
			// 		},
			// 		{
			// 			element: '[name="_envira_gallery[social_lightbox_facebook_show_option_quote]"]',
			// 			type: 'checked',
			// 			operator: 'is'
			// 		}
			// 	],
			// 	actions: {
			// 		if: {
			// 			element: '#envira-config-social-lightbox-networks-facebook-quote',
			// 			action: 'show'
			// 		},
			// 		else: {
			// 			element: '#envira-config-social-lightbox-networks-facebook-quote',
			...
			// 		},
			// 		{
			// 			element: '[name="_envira_gallery[social_lightbox_facebook_show_option_tags]"]',
			// 			type: 'checked',
			// 			operator: 'is'
			// 		}
			// 	],
			// 	actions: {
			// 		if: {
			// 			element: '#envira-config-social-lightbox-networks-facebook-tags-options',
			// 			action: 'show'
			// 		},
			// 		else: {
			// 			element: '#envira-config-social-lightbox-networks-facebook-tags-options',
			...
			// 		},
			// 		{
			// 			element: '[name="_envira_gallery[social_lightbox_facebook_tag_options]"]',
			// 			type: 'value',
			// 			operator: 'array',
			// 			condition: [ 'manual' ]
			// 		}
			...
			// 	actions: {
			// 		if: {
			// 			element: '#envira-config-social-lightbox-networks-facebook-tags-options-manual',
			// 			action: 'show'
			// 		},
			// 		else: {
			// 			element: '#envira-config-social-lightbox-networks-facebook-tags-options-manual',
			...
			{	// Mobile - Lightbox
				...
				actions: {
					if: {
						element: '#envira-config-social-lightbox-mobile-box, #envira-config-social-networks-lightbox-mobile-box',
						action: 'show'
					},
					else: {
						element: '#envira-config-social-lightbox-mobile-box, #envira-config-social-networks-lightbox-mobile-box',
