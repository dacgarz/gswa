...
class Envira_Social_Common {
    ...
    function defaults( $defaults, $post_id ) {
        ...
        /* $defaults['social_lightbox_facebook_show_option_optional_text'] = 0;
        $defaults['social_lightbox_facebook_show_option_tags']          = 0;
        $defaults['social_lightbox_facebook_show_option_caption']       = 0;
        $defaults['social_lightbox_facebook_show_option_quote']         = 0;
        $defaults['social_lightbox_facebook_text']                      = '';
        $defaults['social_lightbox_facebook_tag_options']               = 'manual';
        $defaults['social_lightbox_facebook_tags_manual']               = '';
        $defaults['social_lightbox_facebook_quote']                     = ''; */

        // Twitter
        /* $defaults['social_lightbox_twitter_sharing_method']             = '';
        $defaults['social_lightbox_twitter_summary_card_site']          = ''; */

        // Google+
        /* $defaults['social_lightbox_google_desc']                        = ''; */

        // Pinterest
        /* $defaults['social_lightbox_pinterest_type']   = 'pin-one';
        $defaults['social_lightbox_pinterest_rich']   = 0; */

        // Mobile defaults
        $defaults['mobile_social']                              = 0;
        $defaults['mobile_social_facebook']                     = 0;
        $defaults['mobile_social_twitter']                      = 0;
        $defaults['mobile_social_google']                       = 0;
        ...
        $defaults['mobile_social_lightbox_google']              = 0;
