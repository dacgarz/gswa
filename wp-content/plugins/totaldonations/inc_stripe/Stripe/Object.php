...
class MStripe_Object implements ArrayAccess
{
  /**
  ...
  {
    self::$permanentAttributes = new MStripe_Util_Set(array('_apiKey', 'id'));
    self::$nestedUpdatableAttributes = new MStripe_Util_Set(array('metadata'));
  }
  ...
  public function __construct($id=null, $apiKey=null)
  {
    $this->_apiKey = $apiKey;
    $this->_values = array();
    $this->_unsavedValues = new MStripe_Util_Set();
    $this->_transientValues = new MStripe_Util_Set();
  ...
  public function refreshFrom($values, $apiKey, $partial=false)
  {
    ...
    foreach ($values as $k => $v) {
      ...
      if (self::$nestedUpdatableAttributes->includes($k) && is_array($v)) {
        $this->_values[$k] = MStripe_Object::scopedConstructFrom(
            'MStripe_AttachedObject', $v, $apiKey
        );
      } else {
        $this->_values[$k] = MStripe_Util::convertToStripeObject($v, $apiKey);
      }
  ...
  public function serializeParameters()
  {
    ...
    foreach (self::$nestedUpdatableAttributes->toArray() as $property) {
      if (isset($this->$property)
          && $this->$property instanceOf MStripe_Object) {
  ...
  {
    if ($recursive) {
      return MStripe_Util::convertStripeObjectToArray($this->_values);
    } else {
      return $this->_values;
    }
  }
