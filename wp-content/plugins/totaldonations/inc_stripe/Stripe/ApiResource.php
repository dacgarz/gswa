...
abstract class MStripe_ApiResource extends MStripe_Object
{
  public static function baseUrl()
  {
    return Migla_Stripe::$apiBase;
  }

  protected static function _scopedRetrieve($class, $id, $options=null)
  {
    $opts = MStripe_RequestOptions::parse($options);
  ...
  {
    $requestor = new MStripe_ApiRequestor($this->_apiKey, self::baseUrl());
  ...
  public function instanceUrl()
  {
    ...
    if ($id === null) {
      ...
      throw new MStripe_InvalidRequestError($message, null);
    }
  ...
  private static function _validateCall($method, $params=null, $options=null)
  {
    if ($params && !is_array($params)) {
      ...
      throw new MStripe_Error($message);
    }
  ...
  protected static function _scopedAll($class, $params=null, $options=null)
  {
    ...
    $opts = MStripe_RequestOptions::parse($options);
    $requestor = new MStripe_ApiRequestor($opts->apiKey, $base);
    list($response, $apiKey) = 
      $requestor->request('get', $url, $params, $opts->headers);
    return MStripe_Util::convertToStripeObject($response, $apiKey);
  }
  ...
  protected function _scopedSave($class, $options=null)
  {
    ...
    $opts = MStripe_RequestOptions::parse($options);
    $key = ($opts->apiKey ? $opts->apiKey : $this->_apiKey);
    $requestor = new MStripe_ApiRequestor($key, self::baseUrl());
