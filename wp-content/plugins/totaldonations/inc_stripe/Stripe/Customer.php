...
class MStripe_Customer extends MStripe_ApiResource
{
  /**
  ...
  public function addInvoiceItem($params=null)
  {
    ...
    $ii = MStripe_InvoiceItem::create($params, $this->_apiKey);
    return $ii;
  }
  ...
  public function invoices($params=null)
  {
    if (!$params)
      $params = array();
    $params['customer'] = $this->id;
    $invoices = MStripe_Invoice::all($params, $this->_apiKey);
    return $invoices;
  }
  ...
  public function invoiceItems($params=null)
  {
    if (!$params)
      $params = array();
    $params['customer'] = $this->id;
    $iis = MStripe_InvoiceItem::all($params, $this->_apiKey);
    return $iis;
  }
  ...
  public function charges($params=null)
  {
    if (!$params)
      $params = array();
    $params['customer'] = $this->id;
    $charges = MStripe_Charge::all($params, $this->_apiKey);
    return $charges;
  }
